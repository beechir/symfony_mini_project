 ...
 */
final class Version20251016092654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, aythor_book_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, publicat_on_date DATE NOT NULL, enabled TINYINT(1) NOT NULL, INDEX IDX_CBE5A331C9229539 (aythor_book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reader (id INT AUTO_INCREMENT NOT NULL, use_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A331C9229539 FOREIGN KEY (aythor_book_id) REFERENCES author (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP FOREIGN KEY FK_CBE5A331C9229539');
